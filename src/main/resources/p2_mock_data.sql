  ...
  INSERT INTO accounts (type_type_id, balance, pin, user_user_id, fake_account_id) VALUES
      (1, '5000.00', '1234', 1, 11111111111111),
      (2, '2500.00', '5678', 2, 11111111111111),
      (3, '1000.00', '9012', 3, 11111111111111),
      (1, '0.00', '3456', 4, 11111111111111),
      (2, '2000.00', '7890', 5, 11111111111111),
      (3, '4000.00', '2345', 6, 11111111111111),
      (1, '1500.00', '6789', 7, 11111111111111),
      (2, '3000.00', '0123', 8, 11111111111111),
      (3, '0.00', '4567', 9, 11111111111111),
      (1, '5000.00', '8901', 10, 11111111111111),
      (2, '1800.00', '2345', 11, 11111111111111),
      (3, '3200.00', '6789', 12, 11111111111111),
      (1, '2800.00', '0123', 13, 11111111111111),
      (2, '4500.00', '4567', 14, 11111111111111),
      (3, '0.00', '8901', 15, 11111111111111),
      (1, '7000.00', '2345', 16, 11111111111111),
      (2, '2600.00', '6789', 17, 11111111111111),
      (3, '4800.00', '0123', 18, 11111111111111),
      (1, '3500.00', '4567', 19, 11111111111111),
      (2, '5000.00', '8901', 20, 11111111111111);
